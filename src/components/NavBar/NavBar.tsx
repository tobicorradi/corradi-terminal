...
const ThemeSunIcon = () => (
  <svg aria-hidden="true" className={styles.themeGlyph} viewBox="0 0 24 24">
    <circle cx="12" cy="12" r="3.8" fill="none" stroke="currentColor" strokeWidth="1.8" />
    <path
      d="M12 2.5v3M12 18.5v3M21.5 12h-3M5.5 12h-3M18.72 5.28l-2.14 2.14M7.42 16.58l-2.14 2.14M18.72 18.72l-2.14-2.14M7.42 7.42 5.28 5.28"
      fill="none"
      stroke="currentColor"
      strokeLinecap="round"
      strokeWidth="1.8"
...
const ThemeMoonIcon = () => (
  <svg aria-hidden="true" className={styles.themeGlyph} viewBox="0 0 24 24">
    <path
      d="M14.82 3.96a8.4 8.4 0 1 0 5.22 14.45A9.4 9.4 0 1 1 14.82 3.96Z"
      fill="none"
      stroke="currentColor"
    ...
    >
      ...
      <div className={styles.actions}>
        ...
        >
          ...
          <span
            aria-hidden="true"
            className={`${styles.themeToggleSlot} ${isLightTheme ? styles.themeToggleSlotActive : ''}`.trim()}
          >
          ...
          <span className={styles.visuallyHidden} suppressHydrationWarning>
            {`Current theme: ${theme}`}
          </span>
        </button>
